...
from team_producer import run_once 
...
with DAG(
    dag_id="team_proucer_daily_dag",
    default_args=default_args,
    description='DAG to run team producer once daily at midnight Egypt time',
    catchup=False,
    schedule='0 0 * * *',  # every day at midnight
    tags=['soccer.team']
) as dag:

    task_run_team = PythonOperator(
        task_id='run_team_producer_once',
